    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ttstorage', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4\u5b58\u50a8', blank=True)),
                ('systorage', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4\u5269\u4f59\u5b58\u50a8', blank=True)),
                ('ttcore', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4CPU\u6838\u6570', blank=True)),
                ('sycore', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4\u5269\u4f59CPU\u6838\u6570', blank=True)),
                ('ttmem', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4\u5185\u5b58\u5927\u5c0f', blank=True)),
                ('symem', models.IntegerField(null=True, verbose_name='\u96c6\u7fa4\u5269\u4f59\u5185\u5b58\u5927\u5c0f', blank=True)),
                ('remark', models.CharField(max_length=200, null=True, verbose_name='\u5907\u6ce8', blank=True)),
                ('storagegroup', models.ForeignKey(verbose_name='\u96c6\u7fa4\u5b58\u50a8\u7ec4', blank=True, to='ResourceManage.StorageGroup', null=True)),
                ('vlangroup', models.ForeignKey(verbose_name='\u96c6\u7fa4\u7f51\u7edc\u7ec4', blank=True, to='ResourceManage.VlanGroup', null=True)),
            ],
            options={
                'ordering': ['-id'],
                'db_table': 'cluster',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(verbose_name='\u7269\u7406\u673a\u6240\u5c5e\u96c6\u7fa4', blank=True, to='ProjectManage.Cluster', null=True)),
                ('domain', models.ForeignKey(verbose_name='\u7269\u7406\u673a\u6240\u5c5e\u57df', blank=True, to='ResourceManage.Domain', null=True)),
            ],
            options={
                'ordering': ['-id'],
                'db_table': 'pm',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(max_length=200, null=True, verbose_name='\u5907\u6ce8', blank=True)),
                ('createuser', models.ForeignKey(verbose_name='\u521b\u5efa\u4eba\u5458', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ['-id'],
                'db_table': 'project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(max_length=30, verbose_name='\u865a\u62df\u673a\u64cd\u4f5c\u7cfb\u7edf')),
                ('cpu', models.CharField(max_length=30, null=True, verbose_name='\u865a\u62df\u673acpu\u6838\u6570', blank=True)),
                ('mem', models.CharField(max_length=30, null=True, verbose_name='\u865a\u62df\u673a\u5185\u5b58\u5927\u5c0f', blank=True)),
                ('disk', models.CharField(max_length=30, null=True, verbose_name='\u865a\u62df\u673a\u78c1\u76d8\u5927\u5c0f', blank=True)),
                ...
                ('remark', models.CharField(max_length=200, null=True, verbose_name='\u5907\u6ce8', blank=True)),
                ('cluster', models.ForeignKey(verbose_name='\u6240\u5c5e\u96c6\u7fa4', blank=True, to='ProjectManage.Cluster', null=True)),
                ('domain', models.ForeignKey(verbose_name='\u865a\u62df\u673a\u6240\u5c5e\u57df', blank=True, to='ResourceManage.Domain', null=True)),
                ('pm', models.ForeignKey(verbose_name='\u6240\u5c5e\u7269\u7406\u673a', blank=True, to='ProjectManage.Pm', null=True)),
                ('project', models.ForeignKey(verbose_name='\u6240\u5c5e\u9879\u76ee', blank=True, to='ProjectManage.Project', null=True)),
                ('soft', models.ForeignKey(verbose_name='\u865a\u62df\u673a\u5b89\u88c5\u8f6f\u4ef6', blank=True, to='ResourceManage.Software', null=True)),
            ],
            options={
                'ordering': ['-id'],
                'db_table': 'vm',
        ...
        migrations.AddField(
            model_name='pm',
            name='project',
            field=models.ForeignKey(verbose_name='\u7269\u7406\u673a\u6240\u5c5e\u9879\u76ee', blank=True, to='ProjectManage.Project', null=True),
        ),
        migrations.AddField(
            model_name='pm',
            name='soft',
            field=models.ForeignKey(verbose_name='\u7269\u7406\u673a\u5b89\u88c5\u8f6f\u4ef6', blank=True, to='ResourceManage.Software', null=True),
        ),
        migrations.AddField(
            model_name='pm',
            name='storagegroup',
            field=models.ForeignKey(verbose_name='\u7269\u7406\u673a\u6240\u5c5e\u5b58\u50a8\u7ec4', blank=True, to='ResourceManage.StorageGroup', null=True),
        ),
        migrations.AddField(
            model_name='pm',
            name='vlangroup',
            field=models.ForeignKey(verbose_name='\u7269\u7406\u673a\u6240\u5c5e\u7f51\u7edc\u7ec4', blank=True, to='ResourceManage.VlanGroup', null=True),
        ),
    ]
