...
class Cluster(models.Model):
    ...
    vlangroup=models.OneToOneField(VlanGroup,verbose_name=u'集群网络组')
    storagegroup=models.OneToOneField(StorageGroup,verbose_name=u'集群存储组')
    ttstorage=models.IntegerField(default=0,blank=True,verbose_name=u'集群存储')
    usedstorage=models.IntegerField(default=0,blank=True,verbose_name=u'集群已用存储')
    systorage=models.IntegerField(default=0,blank=True,verbose_name=u'集群剩余存储')
    ...
    ttmem=models.IntegerField(default=0,blank=True,verbose_name=u'集群内存')
    usedmem=models.IntegerField(default=0,blank=True,verbose_name=u'集群已用内存')
    symem=models.IntegerField(default=0,blank=True,verbose_name=u'集群剩余内存')
    remark=models.CharField(max_length=200,blank=True,null=True,verbose_name=u'备注')
    def __unicode__(self):
